...
data class Team(var teamName:String, var avgGoalsFor:Int, var avgGoalsAgainst: Int, var points:Int,
                var goalsDifference: Int, var goalsFor: Int, var goalsAgainst: Int) {
